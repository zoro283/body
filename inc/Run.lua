...
body = Token:match("(%d+)")
redis:set(body..":VERSION",1)
redis:set(body..":SUDO_ID:",SUDO_USER)
redis:set(body..":DataCenter:",'German')
redis:set(body..":UserNameBot:",BOT_User)
redis:set(body..":NameBot:",BOT_NAME)
redis:hset(body..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3body_INSTALL","Yes")
info = {} 
...
body = Token:match("(%d+)")
our_id = tonumber(body)
ApiToken = "https://api.telegram.org/bot"..Token
Bot_User = redis:get(body..":UserNameBot:")
SUDO_ID = tonumber(redis:get(body..":SUDO_ID:"))
SUDO_USER = redis:hgetall(body..'username:'..SUDO_ID).username
version = redis:get(body..":VERSION")
DataCenter = redis:get(body..":DataCenter:")
...
..'¦ BOT__INFO: \27[1;34m'.. Bot_User..'\27[0;36m » ('..body..')\027[0;32m\n'
...
if msg.type == "pv" and redis:get(body..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if redis:get(body..'sender:'..msg.sender_user_id_..':flood') then
...
if redis:get(body..'group:add'..msg.chat_id_) then 
...
elseif msg.sender_user_id_ == 1507071206 then 
msg.TheRank =  'مطور السورس'
msg.Rank = 1
...
elseif redis:sismember(body..':SUDO_BOT:',msg.sender_user_id_) then 
msg.TheRankCmd = 'المطور'
msg.TheRank = 'مطور البوت'
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(body..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء الاساسي'
msg.TheRank = 'المنشىء الاساسي'
msg.Rank = 3
elseif msg.GroupActive and redis:sismember(body..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المنشىء'
msg.TheRank = 'المنشىء'
msg.Rank = 4
elseif msg.GroupActive and redis:sismember(body..'owners:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'المدير' 
msg.TheRank = 'مدير البوت' 
msg.Rank = 5
elseif msg.GroupActive and redis:sismember(body..'admins:'..msg.chat_id_,msg.sender_user_id_) then 
msg.TheRankCmd = 'الادمن'
msg.TheRank = 'ادمن في البوت'
msg.Rank = 6
elseif msg.GroupActive and redis:sismember(body..'whitelist:'..msg.chat_id_,msg.sender_user_id_) then 
...
local lock_bots = redis:get(body..'lock_bots'..msg.chat_id_)
ZISBOT = false
...
if msg.GroupActive and ZISBOT and redis:get(body..'lock_bots_by_kick'..msg.chat_id_) then
kick_user(msg.sender_user_id_, msg.chat_id_)
end
if msg.content_.members_[0].id_ == our_id and redis:get(body..':WELCOME_BOT') then
SUDO_USER = redis:hgetall(body..'username:'..SUDO_ID).username
sendPhoto(msg.chat_id_,msg.id_,redis:get(body..':WELCOME_BOT'),[[• مرحباً انا بوت ]]..redis:get(body..':NameBot:')..[[ .
...
if msg.GroupActive and redis:get(body..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
return false 
end
...
if msg.Admin then redis:srem(body..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(body..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
if redis:get(body..'mute_text'..msg.chat_id_) then --قفل الدردشه
...
if ScriptFile and ScriptFile.body then 
if msg.text and ScriptFile.ibody then
for k, body in pairs(ScriptFile.body) do
local SearchText = msg.text:match(body)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.ibody(msg,{msg.text:match(body)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",body.." | Plugin is: \27[1;32mScript.lua\27[0m")
...
if ScriptFile.dbody then
if ScriptFile.dbody(msg) == false then
return false
end
...
if Plug.body then 
if msg.text and Plug.ibody then
for k, body in pairs(Plug.body) do
local SearchText = msg.text:match(body)
if SearchText then
if not CheckFlood(msg) then
return false
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(body..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(body..'CmD:'..msg.chat_id_,Mohammad)
msg.text = Mohammad:gsub(Mohammad,mmdi)
end
end
local GetMsg = Plug.ibody(msg,{msg.text:match(body)})
if GetMsg then
print("\27[1;35m¦This_Msg : ",body.." | Plugin is: \27[1;32m"..name.."\27[0m")
sendMsg(msg.chat_id_,msg.id_,GetMsg)
end 
return false
end
...
print("The File "..name.." Not Runing in The Source body")
end 

end
else
print("The File Script.lua Not Runing in The Source body")
...
function tdcli_update_callback(data)
	...
	redis:srem(body..'users',msg.sender_user_id_)
	end
	...
	download_file('https://raw.githubusercontent.com/abazaa/body/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/abazaa/body/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/abazaa/body/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/abazaa/body/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/abazaa/body/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/abazaa/body/master/plugins/games.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	mmd = redis:get(body..":SUDO_ID:")
redis:hset(body..'username:'..tonumber(mmd),'username',msg.text)
	...
	redis:set(body..":SUDO_ID:",msg.text)
...
download(stk,32)
	...
	if redis:get(body..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(body..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(body..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(body..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(body..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(body..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(body..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(body..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
	...
	if redis:get(body..'group:add'..data.chat_.id_) then
	redis:set(body..'group:name'..data.chat_.id_,data.chat_.title_)
	end
	...
	if redis:get(body..'group:add-100'..data.channel_.id_) then
	local linkGroup = (redis:get(body..'linkGroup-100'..data.channel_.id_) or "")
	local NameGroup = (redis:get(body..'group:name-100'..data.channel_.id_) or "")
	...
	redis:mset(
	body..'group:name'..k,IDS.Title,
	body..'num_msg_body'..k,5,
	body..'group:add'..k,true,
	body..'lock_link'..k,true,
	body..'lock_spam'..k,true,
	body..'lock_webpage'..k,true,
	body..'lock_markdown'..k,true,
	body..'lock_flood'..k,true,
	body..'lock_bots'..k,true,
	body..'mute_forward'..k,true,
	body..'mute_contact'..k,true,
	body..'mute_document'..k,true,
	body..'mute_inline'..k,true,
	body..'lock_username'..k,true,
	body..'replay'..k,true
	)
	redis:sadd(body..'group:ids',k) 

	if IDS.Admins then
	for user,ID in pairs(IDS.Admins) do
	redis:hset(body..'username:'..ID,'username',user)
	redis:sadd(body..'admins:'..k,ID)
	end
	end
	if IDS.Creator then
	for user,ID in pairs(IDS.Creator) do
	redis:hset(body..'username:'..ID,'username',user)
	redis:sadd(body..':MONSHA_BOT:'..k,ID)
	end
	end
	if IDS.Owner then
	for user,ID in pairs(IDS.Owner) do
	redis:hset(body..'username:'..ID,'username',user)
	redis:sadd(body..'owners:'..k,ID)
	end
	end
	end
	io.popen("rm -fr ../.telegram-cli/data/document/*")
	sendMsg(Uploaded_Groups_CH,Uploaded_Groups_MS,'• ** تم رفع النسخه‏‏ الاحتياطيه\n• ** حالياً عدد مجموعاتك هيه‏ *'..redis:scard(body..'group:ids')..' .*\n')
	end
	elseif data.ID == "UpdateUser" then  
	if data.user_.type_.ID == "UserTypeDeleted" then
	print("¦ userTypeDeleted")
	redis:srem(body..'users',data.user_.id_)
	elseif data.user_.type_.ID == "UserTypeGeneral" then
	local CheckUser = redis:hgetall(body..'username:'..data.user_.id_).username
	...
	redis:hset(body..'username:'..data.user_.id_,'username',USERNAME)
	end 
	end
