...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(body..":NameBot:")
...
var =  'مالك السورس'
elseif  UserID == 1507071206 then
var =  'قل'
elseif  UserID == 1059262308 then
var =  'مطور السورس'
elseif redis:sismember(body..':SUDO_BOT:',UserID) then
var = 'مطور البوت' 
elseif redis:sismember(body..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(body..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء' 
elseif redis:sismember(body..'owners:'..ChatID,UserID) then
var = 'مدير البوت' 
elseif redis:sismember(body..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت' 
elseif redis:sismember(body..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز' 
else
var = 'فقط عضو' 
end
...
if msg.edited then
redis:incr(body..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(body..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(body..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(body..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(body..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(body..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(body..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(body..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(body..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(body..':SUDO_BOT:')
message = '⌘♡  قائمه الـمـطـوريـن : \n\n`⌘مطور اساسي`♡ \n'..SUDO_USER..' » ❪' ..SUDO_ID.. '❫\n*———————————————— *\n'
if #list==0 then  message = message.."* لا يوجد مطورين حاليا \n .*"
else
for k,v in pairs(list) do
local info = redis:hgetall(body..'username:'..v)
local count = redis:scard(body..'mtwr_count'..v)
...
local monsha = redis:smembers(body..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————— \n\n⌘قائمه المدراء :*\n\n'
local list = redis:smembers(body..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(body..'admins:'..msg.chat_id_)
...
local list = redis:smembers(body..'whitelist:'..msg.chat_id_)
...
if redis:sismember(body..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(body..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(body..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(body..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(body..'gban_users')
...
local list = redis:smembers(body..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(body..':Filter_Word:'..msg.chat_id_,word) then 
return  "⌘♡ الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع ." 
else
redis:sadd(body..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(body..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(body..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(body..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(body..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(body..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(body..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(body..'group:ids')
message = '⌘♡ قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(body..'group:name'..v)
if info then 
...
redis:del(
body..'group:add'..id_group,
body..'lock_link'..id_group, 
body..'lock_id'..id_group,
body..'lock_spam'..id_group, 
body..'lock_webpage'..id_group,
body..'lock_markdown'..id_group,
body..'lock_flood'..id_group,
body..'lock_bots'..id_group,
body..'mute_forward'..id_group,
body..'mute_contact'..id_group,
body..'mute_location'..id_group,
body..'mute_document'..id_group,
body..'mute_keyboard'..id_group,
body..'mute_game'..id_group,
body..'mute_inline'..id_group,
body..'lock_username'..id_group,
body..'num_msg_body'..id_group,
body..'replay'..id_group
)
redis:srem(body..'group:ids',id_group)
end
...
redis:hset(body..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(body..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(body..'group:add'..msg.chat_id_) then  return '⌘♡ المجموعة تم تفعيلها مُسبقاً . ' end
...
redis:setex(body..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(body..':addnumberusers') or 0)
...
local lock_service = redis:get(body..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(body..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(body..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
body..'group:add'..msg.chat_id_,true,
body..'lock_link'..msg.chat_id_,true, 
body..'lock_id'..msg.chat_id_,true,
body..'lock_spam'..msg.chat_id_,true,
body..'lock_webpage'..msg.chat_id_,true,
body..'lock_markdown'..msg.chat_id_,true,
body..'lock_flood'..msg.chat_id_,true,
body..'lock_bots'..msg.chat_id_,true,
body..'mute_forward'..msg.chat_id_,true,
body..'mute_contact'..msg.chat_id_,true,
body..'mute_location'..msg.chat_id_,true,
body..'mute_document'..msg.chat_id_,true,
body..'mute_keyboard'..msg.chat_id_,true,
body..'mute_game'..msg.chat_id_,true,
body..'mute_inline'..msg.chat_id_,true,
body..'lock_username'..msg.chat_id_,true,
body..'num_msg_body'..msg.chat_id_,5, 
body..'replay'..msg.chat_id_,true
)

redis:sadd(body..'group:ids',msg.chat_id_) 
redis:sadd(body..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(body..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(body..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(body..'group:add'..msg.chat_id_) then return '♡  المجموعه تم تعطيلها مُسبقاً .' end  
...
if redis:sismember(body..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(body..'username:'..UserID,'username',Resolv)
redis:sadd(body..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تمت ترقيته ليصبح منشىء \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(body..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(body..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(body..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(body..'username:'..UserID,'username',Resolv)
redis:sadd(body..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تمت ترقيته ليصبح منشىء اساسي \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(body..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(body..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(body..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(body..'username:'..UserID, 'username', Resolv)
redis:sadd(body..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(body..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(body..'whitelist:'..ChatID,UserID)
...
if redis:sismember(body..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(body..'username:'..UserID, 'username', Resolv)
redis:sadd(body..'owners:'..ChatID,UserID)
...
if redis:sismember(body..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(body..'username:'..UserID, 'username', Resolv)
redis:sadd(body..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(body..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(body..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(body..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(body..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(body..'msgs:'..UserID..':'..ChatID) or 1
...
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك حظر مطور السورس\n") 
elseif UserID == 1507071206 then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك حظر بودي باشا\n") 
elseif redis:sismember(body..':SUDO_BOT:',UserID) then 
...
redis:hset(body..'username:'..UserID, 'username', Resolv)
redis:sadd(body..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم حظره  \n',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(body..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم بالتأكيد الغاء حظره  \n',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم الغاء حظره \n',17,USERCAR) 
end
redis:srem(body..'banned:'..ChatID,UserID)
...
if redis:sismember(body..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم بالتأكيد كتمه  \n',17,USERCAR) 
end
redis:hset(body..'username:'..UserID, 'username', Resolv)
redis:sadd(body..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم كتمه \n',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(body..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم بالتاكيد الغاء كتمه  \n',17,USERCAR) 
end
redis:srem(body..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم الغاء كتمه  \n',17,USERCAR) 
end
...
redis:hset(body..'username:'..UserID, 'username',Resolv)
redis:sadd(body..'gban_users',UserID)
...
redis:srem(body..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم الغاء حظره العام \n',17,USERCAR) 
end
...
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك طرد مطور السورس\n") 
elseif UserID == 1507071206 then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك طرد بودي باشا\n") 
elseif redis:sismember(body..':SUDO_BOT:',UserID) then 
...
if redis:sismember(body..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد مطور \n',17,USERCAR) 
end
redis:hset(body..'username:'..UserID, 'username', Resolv)
redis:sadd(body..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم ترقيته ليصبح مطور \n',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(body..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘انه بالتأكيد ليس مطور \n',17,USERCAR) 
end
redis:srem(body..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم تنزيله من المطور \n',17,USERCAR) 
end  -- End Cmd 
end,nil)
else
...
elseif UserID == 1507071206 then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك تقييد بودي باشا\n") 
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك تقييد مطور السورس\n") 
elseif redis:sismember(body..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك تقييد المطور\n") 
...
redis:hset(body..'username:'..UserID, 'username', UserName)
redis:sadd(body..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(body..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'⌘♡ العضو » ❪ '..UserName..' ❫\n⌘♡ الايدي » ❪ `'..UserID..'` ❫\n⌘♡ تم بالتأكيد حظره \n') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك كتم مطور السورس\n")
elseif UserID == 1507071206 then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك كتم بودي باشا\n") 
elseif UserID == 1059262308 then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك كتم مطور السورس\n") 
elseif redis:sismember(body..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك كتم المطور\n") 
...
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك طرد المطور\n") 
elseif
redis:sismember(body..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك طرد المنشئ\n") 
elseif redis:sismember(body..'owners:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"⌘♡ لا يمكنك طرد المدير\n") 
elseif redis:sismember(body..'admins:'..ChatID,UserID) then 
...
Restrict(ChatID,UserID,1)
redis:hset(body..'username:'..UserID, 'username', Resolv)
redis:sadd(body..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم تقييد آلعضـو بنجاح \n',17,USERCAR) 
end 
if cmd =="fktqeed" then
  Restrict(ChatID,UserID,2)
  redis:srem(body..':tqeed:'..ChatID,UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(body..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'⌘♡ العضو » '..USERNAME..' \n⌘♡  الايدي » (`'..UserID..'`)\n⌘♡ انه بالتأكيد ليس مطور \n') end
redis:srem(body..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'⌘العضو » ❪ '..USERNAME..' ❫\n⌘الايدي » ❪ '..UserID..' ❫\n⌘تم تنزيله من المطور \n',17,USERCAR) 
end
...
if redis:get(body..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(body..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(body..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(body..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*⚘*` اعدادات المجموعه :` \n"
.."\n⌘التعديل «» "..(redis:get(body..'lock_edit'..msg.chat_id_) or 'false')
.."\n⌘الروابط «» "..(redis:get(body..'lock_link'..msg.chat_id_) or 'false')
.."\n⌘التاك «» "..(redis:get(body..'lock_tag'..msg.chat_id_) or 'false')
.."\n⌘المعرفات «» "..(redis:get(body..'lock_username'..msg.chat_id_) or 'false')
.."\n⌘التكرار «» "..(redis:get(body..'lock_flood'..msg.chat_id_) or 'false')
.."\n⌘الكلايش «» "..(redis:get(body..'lock_spam'..msg.chat_id_) or 'false')
.."\n⌘الويب «» "..(redis:get(body..'lock_webpage'..msg.chat_id_) or 'false')
.."\n⌘الماركدوان «» "..(redis:get(body..'lock_markdown'..msg.chat_id_) or 'false')
.."\n⌘بالطرد البوتات «» "..(redis:get(body..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n⌘البوتات «» "..(redis:get(body..'lock_bots'..msg.chat_id_) or 'false')
.."\n⌘عدد التكرار «» "..(redis:get(body..'num_msg_body'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚘`اعدادات الوسائط :`\n"
.."\n*⌘*المتحركه «» "..(redis:get(body..'mute_gif'..msg.chat_id_) or 'false')
.."\n⌘الدردشه «» "..(redis:get(body..'mute_text'..msg.chat_id_) or 'false')
.."\n⌘الانلاين «» "..(redis:get(body..'mute_inline'..msg.chat_id_) or 'false')
.."\n⌘الالعاب «» "..(redis:get(body..'mute_game'..msg.chat_id_) or 'false')
.."\n⌘الصور «» "..(redis:get(body..'mute_photo'..msg.chat_id_) or 'false')
.."\n⌘الفيديو «» "..(redis:get(body..'mute_video'..msg.chat_id_) or 'false')
.."\n⌘البصمات «» "..(redis:get(body..'mute_audio'..msg.chat_id_) or 'false')
.."\n⌘الصوت «» "..(redis:get(body..'mute_voice'..msg.chat_id_) or 'false')
.."\n⌘الملصقات «» "..(redis:get(body..'mute_sticker'..msg.chat_id_) or 'false')
.."\n⌘الجهات «» "..(redis:get(body..'mute_contact'..msg.chat_id_) or 'false')
.."\n⌘التوجيه «» "..(redis:get(body..'mute_forward'..msg.chat_id_) or 'false')
.."\n⌘الموقع «» "..(redis:get(body..'mute_location'..msg.chat_id_) or 'false')
.."\n⌘الملفات «» "..(redis:get(body..'mute_document'..msg.chat_id_) or 'false')
.."\n⌘الاشعارات «» "..(redis:get(body..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n⌘الكيبورد «» "..(redis:get(body..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚘*`اعدادات اخرى : `"
.."\n\n*⚘*الترحيب «» "..welcomex
.."\n*⚘*الردود «» "..replayx
...
.."\n*⚘*الويب «» "..(redis:get(body..'lock_webpage'..msg.chat_id_) or 'false')
.."\n*⚘*الماركدوان «» "..(redis:get(body..'lock_markdown'..msg.chat_id_) or 'false')
.."\n*⚘*البوتات بالطرد «» "..(redis:get(body..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n*⚘*البوتات «» "..(redis:get(body..'lock_bots'..msg.chat_id_) or 'false')
.."\n*⚘*عدد التكرار «» "..(redis:get(body..'num_msg_body'..msg.chat_id_) or 'false')
.."\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*⚘*اعدادات التقـييد :\n"
.."\n*⚘*التقييد بالتوجيه «» "..(redis:get(body..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*⚘*التقييد بالصور «» "..(redis:get(body..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*⚘*التقييد بالروابط «» "..(redis:get(body..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*⚘*التقييد بالمتحركه «» "..(redis:get(body..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*⚘*التقييد الفيديو «» "..(redis:get(body..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
